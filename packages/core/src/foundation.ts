...
export function generateFoundationCSS(): string {
  const layers = [
    { name: 'reset' as const, content: generateResetLayer() },
    { name: 'tokens' as const, content: `:root {\n${generateTokenCSS()}\n}` },
    { name: 'base' as const, content: generateBaseLayer() },
    { name: 'layouts' as const, content: generateLayoutsLayer() },
    { name: 'components' as const, content: '/* Component styles */' },
    { name: 'utilities' as const, content: generateUtilitiesLayer() },
    { name: 'motion' as const, content: '/* Motion keyframes will be generated by compiler */' },
    { name: 'overrides' as const, content: '/* User overrides */' },
  ];
